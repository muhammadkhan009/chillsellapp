					...
					<aside>
						...
						<div class="card sidebar-card">
							...
							<div class="card-content">
								<div class="card-body text-left">
									<ul>
										<li><i class="fas fa-check-circle"></i> {{ t('Meet seller at a public place') }} </li>
										<li><i class="fas fa-check-circle"></i> {{ t('Check the item before you buy') }} </li>
										<li><i class="fas fa-check-circle"></i> {{ t('Pay only after collecting the item') }} </li>
									</ul>
