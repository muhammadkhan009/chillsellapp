			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav ml-auto navbar-right">
					...
					@else
						...
						<li class="dropdown-item"><a href="{{ url('account/favourite') }}"><i class="icon-heart-1"></i></a></li>
					...
					<?php
						...
						if (!auth()->check()) {
							if (config('settings.single.guests_can_post_ads') != '1') {
								$addListingUrl = \App\Helpers\UrlGen::login();
					...
					<li class="nav-item postadd">
						<a class="btn btn-block btn-border btn-post btn-add-listing" href="{{ $addListingUrl }}">
