...
@section('content')
	<div class="main-container" id="homepage">
		...
		@endif
		@include('home.inc.popular',$data=['cat_id' => 0, 'sub_limit' => 3])
		@include('home.inc.popular',$data=['cat_id' => 4, 'sub_limit' => 3])
		@include('home.inc.popular',$data=['cat_id' => 3, 'sub_limit' => 3])
