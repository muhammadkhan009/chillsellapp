								...
								<form id="signupForm" class="form-horizontal" method="POST" action="{{ url()->current() }}">
									...
									<fieldset>
										...
										<div class="form-group row required">
											<label class="col-md-4 col-form-label">{{ t('Name') }} 
												@if (!isEnabledField('name'))
													<sup>*</sup>
												@endif
											</label>
											<div class="col-md-6">
										...
										<p>Your name will be displayed on your public profile.</p>
										<!-- country_code -->
										...
										<div class="form-group row">
											<label class="col-md-4 col-form-label"></label>
											<div class="col-md-6">
												<button id="signupBtn" class="btn btn-success btn-lg"> Create account </button>
											</div>
										</div>
										<div class="login-box-btm text-center">
											<p>
												Already have an account?
												<a href="{{ \App\Helpers\UrlGen::Login() }}"><strong>Sign in!</strong></a>
											</p>
										</div>
										<div class="mb-5"></div>
					...
					<div class="reg-sidebar-inner">
						...
						<div class="card sidebar-card">
							<div class="card-content">
								<div class="card-body">
									<h2 class="text-center">Did you registered?</h2>
									<p>Sign in to post your ad.</p>
									<a id="loginBtn" href="{{ \App\Helpers\UrlGen::login() }}" class="btn btn-primary btn-block"> Sign in </a>
								</div>
							</div>
						</div>
						<div class="card sidebar-card">
							<div class="card-content">
								<div class="card-body">
									...
									<p>It will help to make your experience safe and chill</p>
									<ul>
										<li><i class="fas fa-check-circle"></i> It will help to post, edit, delete and manage ads</li>
										<li><i class="fas fa-check-circle"></i> Enjoy all the embedded features on chillsell.ca</li>
										<li><i class="fas fa-check-circle"></i> Chill, Sell and Enjoy!</li>
									</ul>
								</div>
							</div>
						</div>
