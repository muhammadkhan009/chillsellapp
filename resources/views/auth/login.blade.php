							...
							<div class="card-body">
								...
								<div class="form-group">
									<div class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text"><i class="icon-mail fa"></i></span>
										</div>
										<input id="login" name="login" type="text"  class="form-control{{ $loginError }}" value="{{ $loginValue }}">
								...
								<div class="form-group">
									<div class="input-group show-pwd-group">
										...
										<input id="password" name="password" type="password" class="form-control{{ $passwordError }}" autocomplete="off">
					...
					<div class="card sidebar-card">
						<div class="card-content">
							<div class="card-body text-center">
								<h2>Register now</h2>
								<p>Get Control of your account</p>
								<a id="loginBtn" href="{{ \App\Helpers\UrlGen::register() }}" class="btn btn-primary btn-block"> Register Now </a>
							</div>
						</div>
					</div>
				</div>
