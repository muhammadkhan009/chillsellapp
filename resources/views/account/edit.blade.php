									...
									<div class="card-body">
										...
										>
											...
											<div class="form-group row required">
												<span class="col-md-3 font-weight-bold">{{ t('gender') }}</span>
												<div class="col-md-9">
													@if ($genders->count() > 0)
											...
											<div class="form-group row required">
												<span class="col-md-3 font-weight-bold">{{ t('Name') }} <sup>*</sup></span>
											...
											<div class="form-group row required">
												<span class="col-md-3 font-weight-bold" for="email">{{ t('Username') }}</span>
												<div class="input-group col-md-9">
													<div class="input-group-prepend">
														<span class="input-group-text"><i class="icon-user"></i></span>
													</div>
											...
											<div class="form-group row required">
												<span class="col-md-3 font-weight-bold">{{ t('email') }}
                                            ...
                                            */
											...
											<div class="form-group row required">
												<span for="phone" class="col-md-3 font-weight-bold">{{ t('phone') }}
